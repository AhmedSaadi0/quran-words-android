...
import com.quranwords.di.IoDispatcher
...
class QuranRepositoryImpl @Inject constructor(
    ...
    override fun closeDb() {
        ...
        try {
            com.quranwords.data.local.QuranDatabase.closeIfNeeded()
        } catch (_: Exception) {
        }
    }
    ...
    override suspend fun searchAll(query: String): SearchResult = withContext(ioDispatcher) {
        ...
        val pageSize = com.quranwords.core.util.DatabaseConstants.SEARCH_PAGE_SIZE
        SearchResult(
